...
public abstract class ControllerFX<E> implements Observer<E> {
    ...
    public void initialize() {
        this.stRepo = new StudentFileRepository(new StudentValidator(), "src/main/resources/students.txt");
        this.prRepo = new ProjectFileRepository(new ProjectValidator(), "src/main/resources/projects.txt");
        this.grRepo = new GradeFileRepository(new GradeValidator(), "src/main/resources/resources/grades/");
